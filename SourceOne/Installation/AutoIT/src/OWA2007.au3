...
Dim $LogFile = FileOpen("C:\Scripts\OWA2007_Logging.txt",9)

Dim $hWnd
Dim $WinTitle = "EMC SourceOne Extensions for Microsoft Office OWA 2007 Installation"


; To Maintain in future
Dim $IdDomainEdit = 2939
Dim $IdServiceAccountEdit = 2958
Dim $IdServiceAccountPasswordEdit = 2962
Dim $IdSecurityGroupEdit = 2961
Dim $IdWebSerNameEdit = 3015
...
FileWriteLine($LogFile,_Now() & ":INFO: ES1_OWA2007Setup location: " & $OWALocation )

$hSearch = FileFindFirstFile($OWALocation & "ES1_OWA2007Setup.exe")
