...
Dim $LogFile = FileOpen("C:\Scripts\OWA2013_Logging.txt",9)

Dim $hWnd
Dim $WinTitle = "EMC SourceOne Extensions for Microsoft Office OWA 2013 Installation"



Dim $IdDomainEdit = 2965
Dim $IdServiceAccountEdit = 2984
Dim $IdServiceAccountPasswordEdit = 2988
Dim $IdSecurityGroupEdit = 2987
Dim $IdWebSerNameEdit = 3041
Dim $IdOWARemoveCheckBox = 624
Dim $IdOWARepairCheckBox = 1588
...
FileWriteLine($LogFile,_Now() & ":INFO: ES1_OWA2013Setup location: " & $OWALocation )

$hSearch = FileFindFirstFile($OWALocation & "ES1_OWA2013Setup.exe")

; Check if the search was successful, if not display a message and return False.
    If $hSearch = -1 Then
         FileWriteLine($LogFile,_Now() & ":INFO: No ES1_OWA2013Setup.exe is found")
        Exit
	Else
		$OWABundle = FileFindNextFile($hSearch)
		FileWriteLine($LogFile,_Now() & ":INFO: ES1_OWA2013Setup is found at: " & $OWABundle )
    EndIf
