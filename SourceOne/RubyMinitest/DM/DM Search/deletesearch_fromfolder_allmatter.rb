...
def test_deletesearch_fromfolder_allmatter_webid_1742
    ...
    @dmweb1.Mattertree_items.all_matters_click.click
    @dmweb1.Mattertree_items.matter_plus($mattername,1).click
    @dmweb1.Mattertree_items.matterreview_plus($mattername,1).click
    @dmweb1.Mattertree_items.folder_plus_matterreview($mattername,1,$foldername).click
    @dmweb1.Mattertree_items.search_in_folder($mattername,1,$foldername,$searchname).click
    ...
    @dmweb1.Mattertree_items.matter_plus($mattername,1).click
    @dmweb1.Mattertree_items.matterreview_plus($mattername,1).click
    if !@dmweb1.Mattertree_items.verify_search_infolder_matterriview($mattername,1,$foldername,$searchname)
