...
namespace SupervisorWebAutomation_API
{
    ...
    public class PerformanceTest : BaseTest
    {
        ...
        private List<FlaggedMessage> GetFlaggedMessageList(int id)
        {
            ...
            Assert.IsTrue(getFlaggedMessagesByPageResponse.StatusCode == System.Net.HttpStatusCode.OK, "Flag Multiple : Get Flagged Messages By Page status code is not correct. Status code: " + getFlaggedMessagesByPageResponse.StatusCode.ToString() + errorMsg);
        ...
        private void PrepareMessage(int id)
        {
            ...
            Assert.IsTrue(prepareMessageListResponse.StatusCode == System.Net.HttpStatusCode.OK, "Login: Prepare message list status code is not correct. Status code: " + prepareMessageListResponse.StatusCode.ToString() + errorMsg);
            ...
            Assert.IsTrue(getFlaggedMessagesByPageResponse.StatusCode == System.Net.HttpStatusCode.OK, "Login: Get Flagged Messages By Page status code is not correct. Status code: " + getFlaggedMessagesByPageResponse.StatusCode.ToString() + errorMsg);
            ...
            while (count == 0)
            {
                ...
                Assert.IsTrue(getFlaggedMessagesByPageResponse.StatusCode == System.Net.HttpStatusCode.OK, "Login while: Get Flagged Messages By Page status code is not correct: " + getFlaggedMessagesByPageResponse.StatusCode.ToString() + errorMsg);
                count = ((List<FlaggedMessage>)getFlaggedMessagesByPageResponse.Data).Count;
            }
