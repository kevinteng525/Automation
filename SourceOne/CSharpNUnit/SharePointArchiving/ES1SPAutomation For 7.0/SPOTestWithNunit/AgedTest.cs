...
namespace SPOTestWithNunit
{
    ...
    public class AgedTest
    {
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 day and 0 day!")]
        [Category("DateFilter")]
        public void ACDBetween0dAnd0d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0dAnd0d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 day and 1 day!")]
        [Category("DateFilter")]
        public void ACDBetween0dAnd1d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0dAnd1d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 day and 100 days!")]
        [Category("DateFilter")]
        public void ACDBetween0dAnd100d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0dAnd100d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 day and 1000 days!")]
        [Category("DateFilter")]
        public void ACDBetween0dAnd1000d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0dAnd1000d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 day and 4 weeks!")]
        [Category("DateFilter")]
        public void ACDBetween0dAnd4w()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0dAnd4w.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 month and 0 month!")]
        [Category("DateFilter")]
        public void ACDBetween0mAnd0m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0mAnd0m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 month and 100 months!")]
        [Category("DateFilter")]
        public void ACDBetween0mAnd100m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0mAnd100m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 week and 1 week!")]
        [Category("DateFilter")]
        public void ACDBetween0wAnd1w()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0wAnd1w.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 0 month and 12 months!")]
        [Category("DateFilter")]
        public void ACDBetween0mAnd12m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween0mAnd12m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date between 1 year and 10 years!")]
        [Category("DateFilter")]
        public void ACDBetween1yAnd10y()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDBetween1yAnd10y.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date newer than 0 day!")]
        [Category("DateFilter")]
        public void ACDNewerThan0d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDNewerThan0d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date newer than 10 weeks!")]
        ...
        public void ACDNewerThan10w()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDNewerThan10w.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date newer than 12 months!")]
        [Category("AgedCreatedDateNewerThan")]
        public void ACDNewerThan12m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDNewerThan12m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date newer than 2 years!")]
        [Category("AgedCreatedDateNewerThan")]
        public void ACDNewerThan2y()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDNewerThan2y.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date older than 0 week!")]
        ...
        public void ACDOlderThan0w()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDOlderThan0w.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date older than 100 days!")]
        [Category("AgedCreatedDateOlderThan")]
        public void ACDOlderThan100d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDOlderThan100d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date older than 4 months!")]
        [Category("AgedCreatedDateOlderThan")]
        public void ACDOlderThan4m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDOlderThan4m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items created date older than 1 year!")]
        [Category("AgedCreatedDateOlderThan")]
        public void ACDOlderThan1y()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ACDOlderThan1y.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date between 1 day and 100 days!")]
        ...
        public void AMDBetween1dAnd100d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDBetween1dAnd100d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date between 1 week and 52 weeks!")]
        [Category("AgedModifiedDateBetween")]
        public void AMDBetween1wAnd52w()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDBetween1wAnd52w.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date between 12 month and 100 months!")]
        [Category("AgedModifiedDateBetween")]
        public void AMDBetween12mAnd100m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDBetween12mAnd100m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date between 2 years and 100 months!")]
        [Category("AgedModifiedDateBetween")]
        public void AMDBetween2yAnd100m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDBetween2yAnd100m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date between 1 year and 10 years!")]
        [Category("AgedModifiedDateBetween")]
        public void AMDBetween1yAnd10y()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDBetween1yAnd10y.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date newer than 0 week!")]
        ...
        public void AMDNewerThan0w()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDNewerThan0w.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date newer than 50 days!")]
        [Category("AgedModifiedDateNewer")]
        public void AMDNewerThan50d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDNewerThan50d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date newer than 15 months!")]
        [Category("AgedModifiedDateNewer")]
        public void AMDNewerThan15m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDNewerThan15m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date newer than 9 years!")]
        [Category("AgedModifiedDateNewer")]
        public void AMDNewerThan9y()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDNewerThan9y.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date older than 0 years!")]
        ...
        public void AMDOlderThan0y()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDOlderThan0y.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date older than 20 days!")]
        [Category("AgedModifiedDateOlder")]
        public void AMDOlderThan20d()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDOlderThan20d.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date older than 48 weeks!")]
        [Category("AgedModifiedDateOlder")]
        public void AMDOlderThan48w()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDOlderThan48w.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to archive items modified date older than 30 months!")]
        [Category("AgedModifiedDateOlder")]
        public void AMDOlderThan30m()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "AMDOlderThan30m.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
