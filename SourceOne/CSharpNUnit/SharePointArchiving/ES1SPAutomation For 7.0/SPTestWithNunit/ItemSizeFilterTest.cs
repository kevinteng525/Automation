...
namespace SPTestWithNunit
{
    ...
    public class ItemSizeFilterTest
    {
        ...
        [Test, Description("Test a SP activity can be run to archve items which are larger or eauql 50 and less or equal 500!")]
        ...
        public void SizeDown50Up500()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "SizeDown50Up500.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archve items which are larger or eauql 100!")]
        [Category("ItemSizeFilter")]
        public void SizeDown100()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "SizeDown100.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archve items which are less or eauql 1000!")]
        [Category("ItemSizeFilter")]
        public void SizeUp20()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "SizeUp20.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
