...
namespace SPTestWithNunit
{
    ...
    public class DatedTest
    {
        ...
        [Test, Description("Test a SP activity can be run to archive items created date after 12/16/2009")]
        ...
        public void DCDAfter12162009()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDAfter12162009.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);

                Assert.AreEqual(2, activity1.archivedItemCount, "Archive items the created date after 12/16/2009 failed!");
            }
            catch (Exception e)
            {
        ...
        [Test, Description("Test a SP activity can be run to archive items created date after 02/28/1983")]
        [Category("DatedCreatedDateAfter")]
        public void DCDAfter02281983()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDAfter02281983.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items created date before 12/19/1999")]
        ...
        public void DCDBefore12191999()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDBefore12191999.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);

                Assert.AreEqual(4, activity1.archivedItemCount, "Archive items the created date before 12/19/1999 failed!");
            }
            catch (Exception e)
            {
                Assert.Fail(e.Message);
        ...
        [Test, Description("Test a SP activity can be run to archive items created date before 07/09/2008")]
        [Category("DatedCreatedDateBefore")]
        public void DCDBefore07092008()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDBefore07092008.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items created date between 02/27/2010 and 06/07/2100")]
        ...
        public void DCDBetween02272010And06072100()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDBetween02272010And06072100.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items created date between 07/03/2009 and 07/03/2009")]
        [Category("DatedCreatedDateBetween")]
        public void DCDBetween07032009And07032009()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDBetween07032009And07032009.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);

                Assert.AreEqual(5, activity1.archivedItemCount, "Archive items the created date between 07/03/2009 and 07/03/2009 failed!");
            }
            catch (Exception e)
            {
                Assert.Fail(e.Message);
        ...
        [Test, Description("Test a SP activity can be run to archive items created date exactly on 12/28/2009")]
        ...
        public void DCDExactlyOn12282009()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDExactlyOn12282009.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items created date exactly on 06/09/2100")]
        [Category("DatedCreatedDateExactlyOn")]
        public void DCDExactlyOn06092100()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDExactlyOn06092100.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items created date include all")]
        ...
        public void DCDIncludeAll()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DCDIncludeAll.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date after 01/02/1991")]
        ...
        public void DMDAfter01021991()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDAfter01021991.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date after 07/14/1983")]
        [Category("DatedModifiedDateAfter")]
        public void DMDAfter07141983()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDAfter07141983.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date before 12/21/2009")]
        ...
        public void DMDBefore12212009()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDBefore12212009.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);

                Assert.AreEqual(5, activity1.archivedItemCount, "Archive items the modified date before 12/21/2009 failed!");
            }
            catch (Exception e)
            {
                Assert.Fail(e.Message);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date before 03/05/1983")]
        [Category("DatedModifiedDateBefore")]
        public void DMDBefore03051983()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDBefore03051983.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);

                Assert.AreEqual(4, activity1.archivedItemCount, "Archive items the modified date before 03/05/1983 failed!");
            }
            catch (Exception e)
            {
                Assert.Fail(e.Message);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date between 05/16/1983 and 12/24/1999")]
        ...
        public void DMDBetween05161983And12241999()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDBetween05161983And12241999.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);

                Assert.AreEqual(5, activity1.archivedItemCount, "Archive items the modified date between 05/16/1983 and 12/24/1999 failed!");
            }
            catch (Exception e)
            {
                Assert.Fail(e.Message);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date between 07/08/2009 and 07/08/2009")]
        [Category("DatedModifiedDateBetween")]
        public void DMDBetween07082009And07082009()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDBetween07082009And07082009.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);

                Assert.AreEqual(3, activity1.archivedItemCount, "Archive items the modified date between 07/08/2009 and 07/08/2009 failed!");
            }
            catch (Exception e)
            {
                Assert.Fail(e.Message);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date exactly on 01/02/2010")]
        ...
        public void DMDExactlyOn01022010()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDExactlyOn01022010.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SP activity can be run to archive items modified date exactly on 06/14/2100")]
        [Category("DatedModifiedDateExactlyOn")]
        public void DMDExactlyOn06142100()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "DMDExactlyOn06142100.xml", ActivityTypes.Sharepoint);
                activity1.Create();
                activity1.Run(600);
