...
namespace SPOTestWithNunit
{
    ...
    public class AttachmentFilterTest
    {
        ...
        [Test, Description("Test a SPO activity can be run to exclude doc type!")]
        ...
        public void ExcludeDoc()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ExcludeDoc.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to exclude doc and docx type!")]
        [Category("AttachmentsFilter")]
        public void ExcludeDocDocx()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ExcludeDocDocx.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to exclude doc, docx and jpg type!")]
        [Category("AttachmentsFilter")]
        public void ExcludeDocDocxJpg()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ExcludeDocDocxJpg.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to exclude doc, docx, jpg and txt type!")]
        [Category("AttachmentsFilter")]
        public void ExcludeDocDocxJpgTxt()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ExcludeDocDocxJpgTxt.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to exclude doc, docx, jpg, txt and xls type!")]
        [Category("AttachmentsFilter")]
        public void ExcludeDocDocxJpgTxtXls()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ExcludeDocDocxJpgTxtXls.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
        ...
        [Test, Description("Test a SPO activity can be run to exclude docx, jpg, txt and xls type!")]
        [Category("AttachmentsFilter")]
        public void ExcludeDocxJpgTxtXls()
        {
            ...
            try
            {
                ES1Activity activity1 = ActivityFactory.CreateActivity(activtyPath + "ExcludeDocxJpgTxtXls.xml", ActivityTypes.SharepointOnline);
                activity1.Create();
                activity1.Run(600);
