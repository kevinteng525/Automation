...
namespace Saber.Common
{
    public class ADManager
    {
        ...
        public static SearchResult ExecuteLDAPQueryFromLDAPServer(String ldapQueryString, String domainName, String domainAdmin, String domainPassword)
        {
            String ldapPath = "LDAP://" + domainName;

            DirectoryEntry entry = new DirectoryEntry(ldapPath, domainAdmin, domainPassword);
