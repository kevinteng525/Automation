...
{
    public class ZincBuildServer : IBuildProvider
    {
        private string localMapFolder = Core.LocalMappedFolder.ZincBuildFolder;

        private string productFolderName = "zinc";

        private string ProductName = "Zinc";

        private string ZincBuildNamePattern = @"^[0-9]\.[0-9]\.[0-9]\.[0-9]{1,4}$";
        ...
        {
            foreach (Build buildOnBuildFileServer in GetAllBuildsOnZincBuildServer())
            {
        ...
        public IList<Build> GetAllBuildsOnZincBuildServer()
        {
            List<Build> builds = new List<Build>();

            System.Text.RegularExpressions.Regex reg = new System.Text.RegularExpressions.Regex(ZincBuildNamePattern);
